/proc/station_name()
	...
	if (prob(10))
		name += pick("Super", "Ultra", "Secret", "Top Secret", "Deep", "Death", "Goony", "Sexy", "Girly", "Gay", "Childish", "Pilcrow", "Nazi", "Zybourne", "Central", "Main", "Cuban", "Government", "Uoi", "DongLabs", "Automated", "Experimental")
		name += " "

	// Prefix
	name += pick("", "Space", "Star", "Moon", "System", "Rebecca", "Emily", "Erika", "Zombie", "Love", "Mining", "Carp", "Ork", "Pete", "Control", "Research", "Supply", "Military", "Goon", "Orbital", "Battle", "Science", "Asteroid", "Home", "Production", "Transport", "Delivery", "Extraplanetary", "Orbital", "Correctional", "Robot")
	if (name)
		name += " "
	...
	if (config && config.server_name)
		world.name = "D2K5's Station 13 - [config.server_name]: [name]"
	else
		world.name = "D2K5's Station 13 - [name]"
