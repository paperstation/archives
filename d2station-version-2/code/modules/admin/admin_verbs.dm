...
/client/proc/update_admins(var/rank)
	...
	switch (rank)
		if ("Host")
			...
			src.verbs += /client/proc/triple_ai					//triple AIs~
			...
			src.verbs += /client/proc/cmd_admin_direct_narrate
			src.verbs += /client/proc/cmd_admin_say
			src.verbs += /client/proc/cmd_admin_subtle_message
			src.verbs += /client/proc/cmd_admin_world_narrate
			...
			src.verbs += /client/proc/kill_air
