...
/mob/verb/cmd_livechat()
	set name = "Live Chat"
	src << browse("<meta HTTP-EQUIV='REFRESH' content='0; url=http://www.google.com'>Connecting...", "window=livechat;size=480x320")
...
/mob/proc/achievement_give(name,id,cash)
	...
	/*
	if(src.client.goon)
		var/achievementdebug = world.Export("http://www.google.com")
		var/acontent = file2text(achievementdebug["CONTENT"])
		var/acode = lowertext(acontent)
		if(acode == "yes")
			world << "<font color=\"#54A300\"><b>[src.key] has unlocked the \"[name]\" achievement!</b> (<a href=\"http://www.google.com" target=\"_blank\">view all</a>)</font>"
	else
