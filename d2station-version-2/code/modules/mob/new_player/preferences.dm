...
*/
	...
	proc/SetChoices(mob/user, occ=1)
		...
		if(!IsGuestKey(user.key))
			//HTML += "<font color=\"red\"><b>IF YOU WANT TO PLAY AS SOME OF THE JOBS YOU MUST GET WHITELISTED, YOU CAN DO THIS <a href=\"http://www.google.com" target=\"_blank\">RIGHT HERE</a></b></font><br>"
