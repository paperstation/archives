/obj/machinery/disease2/incubator/
	...
	var/obj/item/weapon/reagent_containers/glass/virusdish/dish
	...
	attackby(var/obj/B as obj, var/mob/user as mob)
		if(istype(B, /obj/item/weapon/reagent_containers/glass) || istype(B,/obj/item/weapon/reagent_containers/syringe))
			...
			if(istype(B,/obj/item/weapon/reagent_containers/glass/virusdish))
				if(src.dish)
...
//				dish.virus2.infectionchance -= 1
		...
		if(beaker)
			if(!beaker.reagents.remove_reagent("synthblood",5))
				foodsupply += 10
