	...
	*/
	...
	switch(rank)
		if ("Chaplain")
			...
			spawn(0)
				var/religion_name = "Spacism"
				var/new_religion = input(src, "You are the Chaplain. Would you like to change your religion? Default is Spacism.", "Name change", religion_name)
		...
		if ("Geneticist")
			...
			src.equip_if_possible(new /obj/item/device/flashlight/pen(src), slot_l_store)
			src.equip_if_possible(new /obj/item/weapon/storage/backpack/medic(src), slot_back)
			// src.equip_if_possible(new /obj/item/clothing/head/stockingcap(src), slot_head) //XMAS
...
//			src.equip_if_possible(new /obj/item/weapon/storage/backpack(src), slot_back)
		...
		if ("Detective")
			...
			src.equip_if_possible(new /obj/item/clothing/under/rank/det(src), slot_w_uniform)
...
//			src.equip_if_possible(new /obj/item/device/flash(src), slot_l_store)
		...
		if ("Head of Personnel")
			src.equip_if_possible(new /obj/item/device/radio/headset/headset_com (src), slot_ears)
			src.equip_if_possible(new /obj/item/weapon/storage/backpack(src), slot_back)
			src.equip_if_possible(new /obj/item/device/pda/heads(src), slot_belt)
...
//			src.equip_if_possible(new /obj/item/device/flash(src), slot_l_store)
		...
		if ("Barman")
			...
			src.equip_if_possible(new /obj/item/clothing/suit/armor/vest(src), slot_wear_suit)
			//src.equip_if_possible(new /obj/item/weapon/storage/backpack(src), slot_back)
			src.equip_if_possible(new /obj/item/weapon/ammo/shell/beanbag(src), slot_l_store)
...
//			src.equip_if_possible(new /obj/item/device/pda/medical(src), slot_belt)
		...
		if ("Lawyer")
			src.equip_if_possible(new /obj/item/clothing/under/rank/lawyer/blue(src), slot_w_uniform)
			src.equip_if_possible(new /obj/item/clothing/shoes/black(src), slot_shoes)
			//src.equip_if_possible(new /obj/item/weapon/storage/backpack(src), slot_back)
			src.equip_if_possible(new /obj/item/device/detective_scanner(src), slot_in_backpack)
...
//			src.equip_if_possible(new /obj/item/device/pda/quartermaster(src), slot_belt)
		...
		if ("Chief Medical Officer")
			...
			src.equip_if_possible(new /obj/item/clothing/under/rank/medical(src), slot_w_uniform)
			src.equip_if_possible(new /obj/item/clothing/suit/labcoat(src), slot_wear_suit)
	//		src.equip_if_possible(new /obj/item/weapon/storage/pill_bottle/space_drugs(src), slot_l_hand)
			src.equip_if_possible(new /obj/item/device/flashlight/pen(src), slot_l_store)
		...
		if ("Miner")
			src.equip_if_possible(new /obj/item/device/radio/headset/headset_eng (src), slot_ears)
			src.equip_if_possible(new /obj/item/device/pda/engineering(src), slot_belt)
			src.equip_if_possible(new /obj/item/clothing/under/rank/overalls(src), slot_w_uniform)
		...
		if ("Tourist")
			...
			src.equip_if_possible(new /obj/item/clothing/shoes/touristsandal(src), slot_shoes)
			src.equip_if_possible(new /obj/item/weapon/storage/backpack(src), slot_back)
			src.equip_if_possible(new /obj/item/weapon/camera_test(src), slot_l_hand)
			// src.equip_if_possible(new /obj/item/clothing/head/stockingcap(src), slot_head) //XMAS
