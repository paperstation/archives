...
/obj/machinery/manufacturer
	...
	attack_hand(var/mob/user as mob)
		...
		for(var/obj/item/weapon/ore/O in src.contents)
			...
			if (istype(O,/obj/item/weapon/ore/Elerium)) AMTplas++
		...
		if (AMTplas) dat += "<A href='?src=\ref[src];eject=8'><B>Elerium:</B></A> [AMTplas]<br>"
		...
		if ((usr.contents.Find(src) || ((get_dist(src, usr) <= 1) && istype(src.loc, /turf))))
			...
			if (href_list["eject"])
				...
				switch(operation)
					...
					if(8) ejecting = /obj/item/weapon/ore/Elerium
	...
	attackby(obj/item/weapon/W as obj, mob/user as mob)
		...
		/*else if(istype(W, /obj/item/weapon/cable_coil/))
			...
			else new /obj/item/weapon/ore/Elerium(src)
			load = 2
...
/datum/manufacture/pick
	name = "Pickaxe"
	item = /obj/item/weapon/tgpickaxe
	cost1 = /obj/item/weapon/ore/mauxite
	cname1 = "Mauxite"
	amount1 = 1
	time = 5
...
/datum/manufacture/powerpick
	name = "Powered Pick"
	item = /obj/item/weapon/tgpickaxe/powered
	cost1 = /obj/item/weapon/ore/mauxite
	cname1 = "Mauxite"
	amount1 = 3
	cost2 = /obj/item/weapon/ore/pharosium
