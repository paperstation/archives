...
/obj/item/weapon/cable_coil/blue/New(var/Location, var/Length)
	if(!Length)
		Length = MaxAmount
	Amount = Length
...
/obj/item/weapon/cable_coil/blue/proc/UpdateIcon()
	if(Amount == 1)
...
/obj/item/weapon/cable_coil/blue/examine()
...
/obj/item/weapon/cable_coil/blue/attackby(obj/item/weapon/W, mob/user)
	if( istype(W, /obj/item/weapon/wirecutters) && Amount > 2)
		Amount--
		new/obj/item/weapon/cable_coil/blue(user.loc, 1)
		user << "You cut a length off the [name]."
		UpdateIcon()
		return

	else if( istype(W, /obj/item/weapon/cable_coil/blue) )
		var/obj/item/weapon/cable_coil/blue/C = W
...
/obj/item/weapon/cable_coil/blue/proc/UseCable(var/used)
	if(Amount < used)
		return 0
	else if (Amount == used)
		del src
...
/obj/item/weapon/cable_coil/blue/proc/LayOnTurf(turf/simulated/floor/Target, mob/user)
	...
	if(Target.intact)
		...
		var/obj/cable/blue/Cable = new CableType(null)

		for(var/obj/cable/blue/ExistingCable in Target)
		...
		var/obj/cable/blue/NewCable = new CableType(Target)
...
/obj/item/weapon/cable_coil/blue/proc/JoinCable(obj/cabling/Cable, mob/user)
	...
	if(Cable.Direction1 == DirectionToUser || Cable.Direction2 == DirectionToUser)
		...
		for(var/obj/cable/blue/UnifiedCable in UserLocation)
		...
		var/obj/cable/blue/NewCable = new CableType(CableLocation, 0, DirectionToCable)
		NewCable.add_fingerprint(user)
		...
		for(var/obj/cable/blue/ExistingCable in CableLocation)
		...
		var/obj/cable/blue/NewCable = new CableType(CableLocation, NewDirection1, NewDirection2)
		NewCable.add_fingerprint(user)
		NewCable.UserTouched(user)
		NewCable.UpdateIcon()
...
/obj/item/weapon/cable_coil/blue/afterattack(var/atom/Target, var/mob/User, var/Flag)
	var/obj/cable/blue/Cable = new CableType(null)
	...
	var/obj/cable/blue/NewCable = new CableType(CableLocation, 0, DirectionToUser)
	NewCable.add_fingerprint(User)
	NewCable.UserTouched(User)
	NewCable.UpdateIcon()
	UseCable(1)
