...
/obj/cable/blue/New(var/Location, var/NewDirection1 = -1, var/NewDirection2 = -1)
	...
	if (ticker)
		...
		if(locate(/obj/cabling) in P)
			var/obj/cable/blue/Cable = locate(/obj/cabling) in P
...
/obj/cable/blue/proc/CableConnections(var/turf/Target, var/IncludeAlreadyConnected = 0)
	var/list/Cables = list()
	var/Direction = get_dir_3d(Target, src)

	for(var/obj/cable/blue/Cable in Target)
...
/obj/cable/blue/proc/AllConnections(var/turf/Target, var/IncludeAlreadyConnected = 0)
...
/obj/cable/blue/proc/CanConnect(var/obj/ConnectTo)
...
/obj/cable/blue/attackby(var/obj/item/weapon/W, var/mob/User)
	var/datum/UnifiedNetwork/Network = Networks[EquivalentCableType]
	...
	if(istype(W, /obj/item/weapon/wirecutters))
		...
		var/obj/item/weapon/cable_coil/blue/Coil = W
...
/obj/cable/blue/proc/DropCablePieces()
	if (DropCablePieceType)
		new DropCablePieceType(loc, Direction1 ? 2 : 1)


/obj/cable/blue/ex_act(severity)
	switch(severity)
		if(1.0)
			var/datum/UnifiedNetwork/Network = Networks[EquivalentCableType]
...
/obj/cable/blue/proc/ObjectBuilt(var/obj/Object)
...
/obj/New()
	...
	if (ticker)
		for(var/Direction in list(0) | cardinal8)
			for (var/obj/cable/blue/Cable in get_step(src, Direction))
