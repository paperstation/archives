...
/obj/machinery/artifact
	...
	process()
		...
		if (src.effectmode == "worldpulse")
			...
			switch(src.effecttype)
				if("healing")
					for (var/mob/living/carbon/M in mobz)
...
/obj/machinery/artifact/proc/Artifact_Activate()
	...
	command_alert("An artifact has been activated nearby or on the station!", "The station crew has managed to activate an alien artifact!")
