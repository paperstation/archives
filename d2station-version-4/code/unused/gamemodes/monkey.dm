...
/datum/game_mode/monkey/post_setup()
	spawn (50)
		...
		for (var/mob/living/carbon/monkey/rabid_monkey in mobz)
...
/datum/game_mode/monkey/declare_completion()
	...
	if (state != MONKEY_MODE_NO_RABID_LEFT)
		for(var/mob/living/carbon/monkey/monkey_player in mobz)
		...
		if(monkeywin)
			for(var/mob/living/carbon/human/human_player in mobz)
