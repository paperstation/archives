...
/obj/item/toy/ferrite
	name = "81 Ferrite"
	desc = "Uh. The hell do I do with this?"
	icon = 'icons/obj/warframe_objs.dmi'
	icon_state = "wf_materials"

/obj/item/toy/credits
	name = "12 Credits"
	desc = "Currency used by foreigners, Nanotrasen only takes Spacebucks."
	icon = 'icons/obj/warframe_objs.dmi'
	icon_state = "wf_credits"