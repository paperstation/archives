...
/obj/item/weapon/book/manual
	...
	bookid = -1	//cannot be copied or modified
...
/obj/item/weapon/book/manual/adamantite
	name = "Adamantite for Dummies (Everyone)"
	icon_state ="bookEngineering"
	author = "A person"
	title = "Adamantite for Dummies (Everyone)"
	dat = {"<html>
				<head>
				<style>
				h1 {font-size: 18px; margin: 15px 0px 5px;}
				...
				<h1>Adamantite for Dummies</h1>
				If your ready this you have no idea what adamantite is, your finding out how to use it, or you thought this was Woodys Got Wood, hopefully the two formers..

				<h2>Step 1:<h2>
				Mine adamantite.

				<h2>Step 2:<h2>
				Feed into the Adamantite Refinery.

				<h2>Step 3A:<h2>
				Feed that as well as plasma into the machine.

				<h2>Step 3B:<h2>
				Make a core, via RnD or the machine. Cores explode when thrown.

				<h2>Step 3C:<h2>
				Screwdriver the refinery open, insert core.

				<h2>Step 3C1:<h2>
				If a core is already installed, screwdriver open the refinery, crowbar the core out.See the letter half of Step 3C.

				<h2>Step 4:<h2>
				Find recipes involving adamantite. Your free recipe involves using fused adamantite matter on a powercell.

				<h2>Step 5:<h2>
				Additional recipes can be found in those damned alien treasure rooms. So keep mining.


				<h1>Warning<h1>
				Adamantite has been know to be highly unstable, so if your creations explode on you, not our fault. So don't pray or that other pray that those non-space gods magically receieve that you blew up because of it.
...
/obj/item/weapon/book/manual/surgery
	name = "Surgery, a brief basic guide"
	icon_state ="bookCloning"
	author = "Steth O. Hacksaw"
	title = "Surgery, a brief guide"
	...
	dat = {"<html>
				...
				<body>
				<h3>Surgery, a brief guide</h3>

				<h4>Brain Removal Surgery</h4>

				Usually used for borging or doing a brain transplant between bodies, to perform you must:
				<p>
				<b>Step one:</b>Place the patient onto a table, preferably an operating table.<br>
				<b>Step two:</b>Aim for the head and apply drapes on the patient..<br>
				<b>Step three:</b> Use the following in this order: Scapel, Hemostat, Retractor, Saw, Hemostat.<br>


				<h4>Appendectomy Surgery</h4>

				Sometimes if a person is in so much pain for no reason, usually their appendix needs to be removed:
				<p>
				<b>Step one:</b>Place the patient onto a table, preferably an operating table.<br>
				<b>Step two:</b>Aim for the chest and apply drapes on the patient..<br>
				<b>Step three:</b> Use the following in this order: Scapel, Hemostat, Retractor, Hemostat.<br>
				<b>Step four:</b> Use your hands to pull out the appendix.<br>
				<b>Step five:</b> Use cautery on the wound to finish the surgery.<br>


				<h4>Eye Surgery</h4>

				Sometimes eye surgery is a lot easier then going through hell making a chemical for them:
				<p>
				<b>Step one:</b>Place the patient onto a table, preferably an operating table.<br>
				<b>Step two:</b>Aim for the head and apply drapes on the patient..<br>
				<b>Step three:</b> Use the following in this order: Scapel, Retractor, Hemostat, Hemostat, Cautery.<br>
				</body>
				</html>
				"}


/obj/item/weapon/book/manual/cargo
	name = "Quartermaster Tips and Tricks"
	icon_state ="bookEngineering"
	author = "Quarter Wizard"
	title = "Quartermaster Tips and Tricks"
	dat = {"<html>
				<head>
				<style>
				h1 {font-size: 18px; margin: 15px 0px 5px;}
				...
				<h1>Quartermaster Tips and Tricks</h1>
				Your job is not as easy as it sounds. Here are few tricks and tips to help you out.

				<h2>Autolathe Tips:<h2>
				Sometimes there is no need to buy metal with supply points, anything metal and glass can be put into the autolathe. Use the mail room conveyor for quick metal.

				<h2>Ordering Tips:<h2>
				You see those stamps off to the side? Stamp the papers that come inside the crates and send them back (inside the crate), you will get more points!
				Be aware that most things you can order already exist on the station, so only order what you actually need.

				<h2>Mail Room Tips:<h2>
				You can send crates through disposals to locations. Simply put everything you want inside the crate, close it, grab a package wrapper and wrap it, and then set a destination with the destination tagger. Finally, put it on the conveyor and send it through the disposal.
				Alternatively, you can use your Mulebots to send them, but they might be intercepted on the way.
				If both of those not possible, call the person there.
...
/obj/item/weapon/book/manual/cmo
	name = "CMOs got Suit Sensors"
	icon_state ="bookCloning"
	author = "Steth O. Hacksaw"
	title = "CMOs got Suit Sensors"
	dat = {"<html>
				<head>
				<style>
				h1 {font-size: 18px; margin: 15px 0px 5px;}
				...
				<h1>CMOs got Suit Sensors</h1>
				One day while the crew was robusting, the CMO got Suit Sensors. Your job might be one of the hardest. All of the departments you watch over can and will use their powers against everyone else. Lets go into a few details that can help YOU prevent this!

				<h2>Suit Sensors:<h2>
				People die, its an everyday thing. Of course that is the thing, they die and don't get found until a few years later when they are already akin to Mr. Bones. Always remember to use your Requests Console to send a station wide annoucement telling the crew to turn suit sensors on!

				<h2>Chemistry:<h2>
				Sometimes you will run out of healing items from the storage room, its normal. Chemistry is your best bet at making more healing supplies. Your main weapon, which is also inside of your Hypospray, is Tricordrazine, which is made from Inaprovaline and Anti-Toxin.
				Notify security if your Chemists are out of hand and passing out items such as Mindbreaker and Space Lube.

				<h2>Genetics:<h2>
				This is the place were all the dead people go, but you already knew that. Your geneticists will mostly focus on super powers, which you will want to watch for. Feel free to give them a dose oc "medicine" if they get out of line with their powers.
				If there are no geneticists, make sure you start cloning people.

				<h2>Virology:<h2>
				Chances are, if you have no virologists you can skip this part. If you do have virologists and your reading this, they let out a disease. Make sure you get that cure out as quick as possible and make sure your virologists don't pull that again.
				</body>
				</html>
			"}
...
/obj/item/weapon/book/manual/starship
	name = "Starships and You!"
	icon_state ="bookEngineeringSingularitySafety"
	author = "Bill Ding"		 // Who wrote the thing, can be changed by pen or PC. It is not automatically assigned
	title = "How to build a starship, for dummies."
//big pile of shit below.
	...
	dat = {"<html>
				...
				<body>
				<h3>How to build a starship:</h3>
				<p>
				<b>Step Zero:</b>Locate the Ship Builder add the following to it:</br>
				<b>Step one:</b> Add a Blasto Module<br>
				<b>Step two:</b> Build and add a Bluespace Crane.<br>
				<b>Step three:</b> Build and add a Dimensional Warpfinder.<br>
				<b>Step four:</b> Pray someone doesn't ruin it.<br>
				<b>Step five:</b> Add an Alien Core.<br>
				<b>Step six:</b> Wrench<br>
				<b>Step seven:</b> Build and add a Adamantite Starship Frame.</b><br>
				<b>Step eight:</b> Add a Hyper Capacity Cell.<br>
				<b>Step nine:</b> Add cables<br>
				<b>Step ten:</b> Add a communications circuit board.<br>
				<b>Step eleven:</b> Add a beacon.<br>
				<b>Step twelve:</b> Wrench.<br>
				<b>Step thirteen:</b> Step back and enjoy your work for a whole few seconds. <br>
				<b>Step fourteen:</b> Watch as people with Starship access from the HoP storm in and take over your starship.<br>
				<b>Step fifteen:</b> <b>Cry</b><br>
				</p>
				</body>
				</html>
				"}