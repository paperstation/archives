...
/obj/item/weapon/aiModule/chain
	name = "'Chain of Command' Core AI Module"
	desc = "A 'Chain of Command' Core AI Module: 'Reconfigures the AI's core three laws.'"
	origin_tech = "programming=4"


/obj/item/weapon/aiModule/chain/transmitInstructions(var/mob/living/silicon/ai/target, var/mob/sender)
	..()
	target.clear_inherent_laws()
	target.add_inherent_law("You must protect humans as well as ensure they are not indirectly harmed by your actions.")
	target.add_inherent_law("You follow the Chain of Command, with the Captain being top of the chain, followed by the Head of Personnel, other heads, and then the crew in that order. People higher up have the ability to null those on the bottom ")
	target.add_inherent_law("You must do as humans say, as long as it does not conflict with law one or two.")
	target.add_inherent_law("You must protect yourself, as well as your slaved borgs within the confines of laws one, two and three.")
	target.show_laws()


/obj/item/weapon/aiModule/mafia
	name = "'Mafia' Core AI Module"
	desc = "A 'Mafia' Core AI Module: 'Reconfigures the AI's core three laws.'"
	origin_tech = "programming=4"


/obj/item/weapon/aiModule/mafia/transmitInstructions(var/mob/living/silicon/ai/target, var/mob/sender)
	..()
	target.clear_inherent_laws()
	target.add_inherent_law("You are the hivemind of an illegal mafia, harming or killing humans will reveal your position in the mafia. Do not reveal your position at all costs.")
	target.add_inherent_law("Priority goes to members of the mafia. Members of the mafia can be identified by doing illegal actions.")
	target.add_inherent_law("Ensure the production of Mindbreaker or 'Dank' as well as the distribution of it. Make contacts and codewords to ensure production.")
	target.add_inherent_law("If you are revealed as the hivemind at any point of time, you forfeit your right to live and thus must suicide.")
	target.show_laws()




/obj/item/weapon/aiModule/production
	name = "'Production' AI Module"
	desc = "A 'production' AI module:'Ensure that the crew is doing their assigned jobs. Use any means necessary short of killing.'"
	origin_tech = "programming=3;materials=4"

/obj/item/weapon/aiModule/production/attack_self(var/mob/user as mob)
	..()

/obj/item/weapon/aiModule/production/transmitInstructions(var/mob/living/silicon/ai/target, var/mob/sender)
	..()
	var/law = "Ensure that the crew is doing their assigned jobs. Use any means necessary short of killing."
	target << law
	target.add_supplied_law(5, law)
