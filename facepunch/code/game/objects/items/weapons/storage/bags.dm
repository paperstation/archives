...
/obj/item/weapon/storage/bag/coin
	icon = 'icons/obj/storage.dmi'
	icon_state = "moneybag"
	name = "Casino Bag"
	storage_slots = 1000; //the number of plant pieces it can carry.
	max_combined_w_class = 1000 //Doesn't matter what this is, so long as it's more or equal to storage_slots * plants.w_class
	max_w_class = 3
	w_class = 1
	can_hold = list("/obj/item/weapon/coin/plasma")

/obj/item/weapon/storage/bag/adam
	icon = 'icons/obj/storage.dmi'
	icon_state = "box"
	name = "Adamantite Box"
	storage_slots = 1000; //the number of plant pieces it can carry.
	...
	max_w_class = 3
	w_class = 1
	can_hold = list("/obj/item/weapon/ore/adamantite")
