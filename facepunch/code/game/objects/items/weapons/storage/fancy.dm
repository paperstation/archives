...
/obj/item/weapon/storage/fancy/cigarettes
	...
	suicide_act(mob/user)
		viewers(user) << pick("\red <b>[user] is shoving the contents of the packet into \his mouth and is lighting them! It looks like \he's trying to commit suicide.</b>", \
							"\red <b>[user] is eating the cigarette pack whole! It looks like \he's trying to commit suicide.</b>")
		return (BRUTELOSS)
