...
/obj/item/device/radio/headset/headset_starship
	name = "science radio headset"
	desc = "A short lived brand of headset. To access the starship channel, use :z."
	icon_state = "com_headset"
	item_state = "headset"
	keyslot2 = new /obj/item/device/encryptionkey/headset_starship
