/obj/item/device/flashlight
	...
	suicide_act(mob/user)
		viewers(user) << pick("\red <b>[user] is staring at the light for too long! It looks like \he's trying to commit suicide.</b>", \
							"\red <b>[user] bashes \his head in with the [name]! It looks like \he's trying to commit suicide.</b>")
		return (BRUTELOSS)
