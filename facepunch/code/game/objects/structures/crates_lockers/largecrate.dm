...
/obj/structure/largecrate/lisa/dead/attackby(obj/item/weapon/W as obj, mob/user as mob)//heehee
	if(istype(W, /obj/item/weapon/crowbar))
		var/mob/living/simple_animal/corgi/Lisa/C = new /mob/living/simple_animal/corgi/Lisa
		C.loc = src.loc
		C.health = 0
	..()
...
/obj/structure/largecrate/grineer
	name = "Grineer supplies"
	desc = "A stack of crates loaded with alien junk."
	icon = 'icons/obj/warframe_objs.dmi'
	icon_state = "grineer_supplies"