...
/obj/machinery/constructable_frame/vendo_frame
	icon_state = "vbox_0"
	attackby(obj/item/P as obj, mob/user as mob)
		switch(state)
			if(1)
				...
				if(istype(P, /obj/item/weapon/wrench))
					...
					del(src)
			if(2)
				if(istype(P, /obj/item/weapon/circuitboard/vendingmachine))
					var/obj/item/weapon/circuitboard/B = P
					if(B.board_type == "machine")
						playsound(src.loc, 'sound/items/Deconstruct.ogg', 50, 1)
						user << "\blue You add the circuit board to the frame."
...
/obj/item/weapon/circuitboard/pacman/blinky
	name = "Circuit Board (BLINKY-type Generator)"
	build_path = "/obj/machinery/power/port_gen/pacman/blinky"
	origin_tech = "programming=3;powerstorage=5;engineering=5"
...
/obj/item/weapon/circuitboard/darkmatter
	name = "Circuit board (Adamantite Refinery)"
	build_path = "/obj/machinery/darkmatter"
	board_type = "machine"
	origin_tech = "programming=2;biotech=2"
	frame_desc = "Requires 1 Scanning module, 1 Manipulator, 1 Micro-Laser, 2 pieces of cable and 1 Console Screen."
	req_components = list(
...
//Vending machine circuits. The main one here your not supposed to get normally.
/obj/item/weapon/circuitboard/vendingmachine
	name = "Circuit board (Vending Machine)"
	build_path = "/obj/machinery/vending/build"
	board_type = "machine"
	origin_tech = "magnets=2;engineering=2;programming=2"
	frame_desc = "Requires 1 Scanning Module, 1 Manipulator, and 1 Micro-Laser."
	req_components = list(
...
/obj/item/weapon/circuitboard/medical
	name = "Vending Board (Cigarette)"
	build_path = "/obj/machinery/vending/build"
	board_type = "machine"
	origin_tech = "magnets=2;engineering=2;programming=2"
