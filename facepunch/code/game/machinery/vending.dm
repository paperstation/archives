			...
			if (R in coin_records)
				...
				if(coin.string_attached)
					if(prob(50))
						...
						usr.unlock_achievement("SUCKERS")
					else
...
/obj/machinery/vending/casino
	...
	icon_state = "casino"
	icon_deny = "casino"
	desc = "Our prices are SO much better than yours!"
	product_slogans = "Win that cash!;We are SO much more elegant than your station brand machines. We only serve PREMIUM!.;We accept all kinds of coins!;Smoke with us now or smoke with us later, either way pay up!"
	product_ads = "Probably not bad for you!;Don't believe the scientists!;It's good for you!;Don't quit, buy more!;Smoke!;Nicotine heaven.;Best cigarettes since 2150.;Award-winning cigs."
	vend_delay = 34
	products = list(/obj/item/weapon/storage/bag/coin = 50)
	contraband = list(/obj/item/weapon/storage/bag/coin = 50)
	premium = list(/obj/item/weapon/storage/bag/coin = 50)
...
/obj/machinery/vending/medical
	...
	#ifdef NEWMAP
	req_access = list(access_medbay_storage_area)
	#else
	req_access_txt = "5"
	#endif
...
/obj/machinery/vending/dinnerware
	...
	contraband = list(/obj/item/weapon/kitchen/utensil/knife = 2,/obj/item/weapon/kitchen/rollingpin = 2, /obj/item/weapon/butch = 2)
...
/obj/machinery/vending/tool
	...
	premium = list(/obj/item/clothing/gloves/fyellow = 2)
...
/obj/machinery/vending/fun
	name = "Fun'O'Vend"
	desc = "Everything you need to let the station fall apart around you."
	icon_state = "robotics"
	vend_delay = 15
	product_slogans = "Got fun?; Did somebody say fun?;Do you have a plus one modifier to fun?;I got your hook up here!"
	product_ads = "You too will join the brainwashing!;Do you have any self respect?!"
	products = list(/obj/item/weapon/storage/box/balls = 20,/obj/item/darts = 6)



/obj/machinery/vending/jani
	name = "JaniVend"
	desc = "I will help you; clean up your act!."
	icon_state = "jani"

	products = list(/obj/item/weapon/reagent_containers/spray/cleaner = 2,/obj/item/weapon/storage/box/mousetraps = 2)
	premium = list(/obj/item/weapon/storage/box/lunchbox = 1)



/obj/machinery/vending/ammo
	name = "AmmoNow"
	desc = "He sells ammo and ammo accessories"
	icon_state = "ammo"
	vend_delay = 15
	product_slogans = "If you weren't shit you wouldn't need to use me!;Oh so NOW you need me!?. I betcha the Head of Personnel tried to come in here!;Nobody loves Mr. Vendy so they put him in this hell hole!;I got your hook up here!"
	product_ads = "I'm always here, doing nothing!;Jump into the singularity!;You can't use AMMO without AMORE guns!."
	req_access_txt = "1"
	products = list(/obj/item/ammo_magazine/c9mm = 2, /obj/item/weapon/gun/projectile/mp80 = 1)