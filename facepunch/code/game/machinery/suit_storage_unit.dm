...
/obj/machinery/suit_storage_unit/explorer
	name = "Explorer Suit Unit"
	SUIT_TYPE = /obj/item/clothing/suit/space/syndicate/blue/nonsyndicate
	HELMET_TYPE = /obj/item/clothing/head/helmet/space/syndicate/blue/nonsyndicate
	MASK_TYPE = /obj/item/clothing/mask/breath

/obj/machinery/suit_storage_unit/traveler
	name = "Ranger Suit Unit"
	SUIT_TYPE = /obj/item/clothing/suit/space/syndicate/green
	HELMET_TYPE = /obj/item/clothing/head/helmet/space/syndicate/green
	MASK_TYPE = /obj/item/clothing/mask/breath


/*/obj/machinery/suit_storage_unit/ertmedic
	name = "ERT Medic Unit"
	SUIT_TYPE = /obj/item/clothing/suit/space/syndicate/blue
	HELMET_TYPE = /obj/item/clothing/head/helmet/space/syndicate/blue
	MASK_TYPE = /obj/item/clothing/mask/breath*/

/obj/machinery/suit_storage_unit/ertengineer
	name = "ERT Engineer Unit"
	SUIT_TYPE = /obj/item/clothing/suit/space/syndicate/orange
	HELMET_TYPE = /obj/item/clothing/head/helmet/space/syndicate/orange
	MASK_TYPE = /obj/item/clothing/mask/breath

/obj/machinery/suit_storage_unit/ertcommon
	name = "ERT Member Unit"
	SUIT_TYPE = /obj/item/clothing/suit/space/syndicate/green
	HELMET_TYPE = /obj/item/clothing/head/helmet/space/syndicate/green
	MASK_TYPE = /obj/item/clothing/mask/breath

/obj/machinery/suit_storage_unit/ert
	name = "ERT Space Suit Unit"
...
/obj/machinery/suit_storage_unit/proc/start_UV(mob/user as mob)
	...
	for(i=0,i<4,i++)
		...
		if(src.OCCUPANT)
			if(src.issuperUV)
				OCCUPANT.deal_overall_damage(0,rand(28,35))
				OCCUPANT.emote("scream")
			else
				OCCUPANT.deal_overall_damage(0,rand(6,10))
				OCCUPANT.emote("scream")
