...
/obj/machinery/smartfridge/bar
	name = "\improper Food and Drink Storage"
	desc = "A refrigerated storage unit for storing foods and drinks"



/obj/machinery/smartfridge/bar/accept_check(var/obj/item/O as obj)
	if(istype(O,/obj/item/weapon/reagent_containers/food))
		return 1
	return 0

/obj/machinery/smartfridge/photos
	name = "Photo Storage"
	desc = "Keeps photos nice and safe."
	density = 0
/obj/machinery/smartfridge/photos/accept_check(var/obj/item/O as obj)
