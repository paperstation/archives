...
// Flasher activation limited to 150 seconds
	attack_hand(var/mob/user as mob)
		...
		if (src.timing)
			dat += "<a href='?src=\ref[src];timing=0'>Stop Timer</a><br/>"// and open door</a><br/>"
		else
			dat += "<a href='?src=\ref[src];timing=1'>Activate Timer</a><br/>"// and close door</a><br/>"
