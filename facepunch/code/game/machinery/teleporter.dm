...
/obj/machinery/teleport/hub/proc/teleport(atom/movable/M as mob|obj)
	...
	if (istype(M, /atom/movable))
		if((!accurate && prob(5)) || faulty) //oh dear a problem, put em in deep space
			do_teleport(M, locate(rand((2*TRANSITIONEDGE), world.maxx - (2*TRANSITIONEDGE)), rand((2*TRANSITIONEDGE), world.maxy - (2*TRANSITIONEDGE)), pick(3,4)), 2)
		else
