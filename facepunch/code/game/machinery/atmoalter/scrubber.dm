...
/obj/machinery/portable_atmospherics/scrubber/huge
	...
	attack_hand(var/mob/user as mob)
		if(!anchored)
			usr << "\blue The [src.name] needs to be anchored to the floor first."
			return
		..()
		return
...
/obj/machinery/portable_atmospherics/scrubber/attack_hand(var/mob/user as mob)
	...
	if(edit_power)
		output_text += "Power regulator: <A href='?src=\ref[src];volume_adj=-1000'>-</A> <A href='?src=\ref[src];volume_adj=-100'>-</A> <A href='?src=\ref[src];volume_adj=-10'>-</A> <A href='?src=\ref[src];volume_adj=-1'>-</A> [volume_rate] <A href='?src=\ref[src];volume_adj=1'>+</A> <A href='?src=\ref[src];volume_adj=10'>+</A> <A href='?src=\ref[src];volume_adj=100'>+</A> <A href='?src=\ref[src];volume_adj=1000'>+</A><BR>"
	output_text += {"<HR>
