...
/obj/machinery/shield/damage(var/amount, var/use_armor = 0)
...
/obj/machinery/shieldgen/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	else if(istype(W, /obj/item/weapon/cable_coil) && is_open)
...
/obj/machinery/shieldwallgen/proc/power()//This is the worst part about this device and makes it next to useless
	if(!anchored)
		power = 0
		return 0
	var/turf/T = src.loc
