...
/datum/game_mode/proc/equip_wizard(mob/living/carbon/human/wizard_mob)
	...
	if(wizard_mob.backbag == 3) wizard_mob.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel(wizard_mob), slot_back)
...
/datum/game_mode/wizard/declare_completion()
	...
	if(finished)
		...
		text += "\red <br><FONT size = 3><B> The wizard[(wizards.len>1)?"s":""] has been killed by the crew! The Space Wizards Federation has been taught a lesson they will not soon forget!</B></FONT>"
	..()
	outputstats += text
	return 1
...
/datum/game_mode/proc/auto_declare_completion_wizard()
	if(wizards.len)
		var/text = "<br><br><FONT size = 2><B>The wizards/witches were:</B></FONT>"
