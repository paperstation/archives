...
/obj/item/weapon/spellbook/attack_self(mob/user as mob)
	...
	if(temp)
		...
		dat += "<A href='byond://?src=\ref[src];spell_choice=mutate'>Far Reach</A> (60)<BR>"
		...
		dat += "<A href='byond://?src=\ref[src];spell_choice=lifesuccubus'>Life Succubus</A> (60)<BR>"
		//if(op) seriously fuck this spell it does not work well in game at all
				...
				if(!already_knows)
					switch(href_list["spell_choice"])
						...
						if("mutate")
							...
							temp = "This spell allows to use powerful telekinesis for a short while."
						if("etherealjaunt")
						...
						if("lifesuccubus")
							...
							H.spell_list += new /obj/effect/proc_holder/spell/targeted/lifesuccubus(H)
							max_uses--
							temp = "Sometimes the best offensive is the best defense. While it does very little damage, it can leach the life and restore you for a portion of whatever it hits!"
						if("staffchange")
						...
						if("armor")
							...
							new /obj/item/clothing/suit/wizrobe/rig(get_turf(H))
							new /obj/item/clothing/head/wizard/helmet(get_turf(H))
