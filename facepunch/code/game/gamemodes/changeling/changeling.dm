...
/datum/game_mode/changeling
	...
	var/const/changeling_amount = 4//Number of lings if scaling is off
	var/const/changeling_scaling_coeff = 8.0 //how much the amount of players are divided by to determine antags
...
/datum/game_mode/proc/auto_declare_completion_changeling()
	if(changelings.len)
		var/text = "<br><br><FONT size = 2><B>The changelings were:</B></FONT>"
		for(var/datum/mind/changeling in changelings)
			var/changelingwin = 1
