/datum/job/captain
	...
	equip(var/mob/living/carbon/human/H)
		...
		H.equip_to_slot_or_del(new /obj/item/clothing/suit/space/captain(H), slot_wear_suit)
...
/datum/job/hop
	...
	#ifdef NEWMAP
	access = list(access_bridge_area, access_hop_area, access_id_computer, access_personal_lockers, access_vault_area,
	...
	access_maint_tunnels_area, access_engineering_area, access_medbay_area, access_security_area, access_cells_area
)//FIX THIS LATER
	#else
	...
	equip(var/mob/living/carbon/human/H)
		...
		spawn(40)//Wait a few seconds before spawning the animal so it spawns in after the character gets to the station
			new/mob/living/simple_animal/corgi/Ian(H.loc)
		return 1