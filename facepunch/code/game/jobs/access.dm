...
/var/const/access_starship = 300
/var/const/access_starship_command = 301

/obj/var/list/req_access = null
/obj/var/req_access_txt = "0"
//obj/var/list/req_one_access = null//TODO: Remove this
...
/proc/get_all_accesses()
	return list(access_security, access_sec_doors, access_brig, access_armory, access_forensics_lockers, access_court,
	            ...
	            access_hydroponics, access_library, access_lawyer, access_virology, access_cmo, access_qm, access_clown, access_mime,
	            access_surgery, access_theatre, access_research, access_mining, access_mailsorting,
...
/proc/get_access_desc(A)
	switch(A)
		...
		if(access_cent_captain)
			return "Emergency Armory"
		if(access_starship)
			return "Starship General"
		if(access_starship_commmand)
