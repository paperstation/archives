/proc/playsound(var/atom/source, soundin, vol as num, vary, extrarange as num)
	...
	switch(soundin)
		...
		if ("explosion") soundin = pick('sound/effects/Explosion1.ogg','sound/effects/Explosion2.ogg', 'sound/effects/Explosion3.ogg')
...
/client/proc/playtitlemusic()
	...
	if(prefs.toggles & SOUND_LOBBY)
		src << sound(ticker.login_music, repeat = 1, wait = 0, volume = 65, channel = 1) // MAD JAMS
...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("hiss") soundin = pick('sound/voice/hiss1.ogg','sound/voice/hiss2.ogg','sound/voice/hiss3.ogg','sound/voice/hiss4.ogg')
			if ("pageturn") soundin = pick('sound/effects/pageturn1.ogg', 'sound/effects/pageturn2.ogg','sound/effects/pageturn3.ogg')
			if ("gunshot") soundin = pick('sound/weapons/Gunshot.ogg')
	return soundin