...
proc/process_teleport_locs()
	for(var/area/AR in world)
		if(istype(AR, /area/shuttle) || istype(AR, /area/syndicate_station) || istype(AR, /area/secrets) || istype(AR, /area/gatewaymissions) || istype(AR, /area/wizard_station)) continue
...
proc/process_ghost_teleport_locs()
	for(var/area/AR in world)
		...
		if(istype(AR, /area/gatewaymissions/) || istype(AR, /area/derelict) || istype(AR, /area/centcom/tdome) || istype(AR, /area/tdome))
...
/area/shuttle/mysterious/centcom
	name = "Unknown"
	icon_state = "shuttlered"

/area/shuttle/mysterious/station
	name = "Unknown"
	icon_state = "shuttlered2"
...
/area/station/ai_monitored/ai/foyer
	name = "AI Foyer"
	icon_state = "storage"
	default_access_req = access_ai_area

/area/station/ai_monitored/ai/securetech
	name = "Secure Technical Storage"
	icon_state = "storage"
	default_access_req = access_secure_tech_storage_area

/area/station/ai_monitored/ai/atmos/medbay
	name = "LAC Control #1"
	icon_state = "storage"

/area/station/ai_monitored/ai/atmos/arrivals
	name = "LAC Control #2"
	icon_state = "storage"

/area/station/ai_monitored/ai/atmos/rd
	name = "LAC Control #3"
	icon_state = "storage"

/area/station/ai_monitored/ai/atmos/eng
	name = "LAC Control #4"
	icon_state = "storage"
...
//	/area/construction,
	/area/station/,
	/area/station/ai_monitored/storage/eva, //do not try to simplify to "/area/ai_monitored" --rastaf0
