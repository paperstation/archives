...
/obj/machinery/keycard_auth/armory
	 name = "Armory Authentication Device"
	 desc = "The armory version of the device; use it to open the armory!"
...
/obj/machinery/keycard_auth/attack_hand(mob/user as mob)
	...
	if(screen == 1)
		...
		dat += "<li><A href='?src=\ref[src];triggerevent=Emergency Armory Door'>Emergency Armory Door</A></li>"
		dat += "</ul>"
...
/obj/machinery/keycard_auth/proc/trigger_event()
	switch(event)
		...
		if("Emergency Armory Door")
			...
			world << "<font color='red'>Hostile threat detected and has been confirmed by Heads of Staff or their subordinates. Due to the nature of this threat; the Emergency Armory has unbolted and opened itself inside the Emergency Armory!</font>"
