...
*/
		...
		serotrotium //Its a bitch to make, but it stops idiots in their tracks
			name = "Serotrotiumm"
			id = "serotrotium"
			result = "serotrotium"
			required_reagents = list("mindbreaker" = 1, "ryetalyn" = 1)
			required_catalysts = list("plasma" = 5)
			result_amount = 1
		...
		hallucinine
			...
			result_amount = 1 //Can be a little OP
		...
		nitroglycerin
			...
			//Snowflake + hacky but I didn't see any of the /TG/ coders set up logging and admin messages for it. Go fig.
			...
			on_reaction(var/datum/reagents/holder, var/created_volume)
				...
				var/log_str = ""
				var/location = get_turf(holder.my_atom)
				var/turf/bombturf = get_turf(holder.my_atom)
				var/area/a = get_area(bombturf)
				var/datum/effect/effect/system/reagents_explosion/e = new()
				log_str = "A nitroglycerin compound has been primed and detonated in <A HREF='?_src_=holder;adminplayerobservecoodjump=1;X=[a.x];Y=[a.y];Z=[a.z]'>[a.name]</a> by <A HREF='?_src_=holder;adminplayerobservecoodjump=1;X=[mob.x];Y=[mob.y];Z=[mob.z]'>[mob.name]/[mob.key]</a> Their antag status is: [mob.mind.special_role] "
				message_admins("A nitroglycerin compound has been primed and detonated in <A HREF='?_src_=holder;adminplayerobservecoodjump=1;X=[a.x];Y=[a.y];Z=[a.z]'>[a.name]</a> by <A HREF='?_src_=holder;adminplayerobservecoodjump=1;X=[mob.x];Y=[mob.y];Z=[mob.z]'>[mob.name]/[mob.key]</a> Their antag status is: [mob.mind.special_role] ")
				if(attacher)
					...
					if(mob)
						...
						log_str += " Last touched by: [holder.my_atom.fingerprintslast][last_touch_info]"
						bombers += log_str
		...
		electrozene
			...
			id = "electrozene"
			result = "electrozene"
			required_reagents = list("sodiumchloride" = 1, "ethylredoxrazine" = 1, "radium" = 1, "plasma" = 1)
			result_amount = 1 //This is game breaking
		...
		slimecrit
			...
			on_reaction(var/datum/reagents/holder)
				...
				var/blocked = list(/mob/living/simple_animal/hostile,
					...
					/mob/living/simple_animal/starship,//WE REALLY DO NOT WANT THIS SPAWNING
					)//exclusion list for things you don't want the reaction to create.
				var/list/critters = typesof(/mob/living/simple_animal/hostile) - blocked // list of possible hostile mobs
...
////DRINKS THAT REQUIRED IMPROVED SPRITES BELOW:: -Agouri/////
		...
		malley
			...
			id = "malley"
			result = "malley"
			required_reagents = list("kahlua" = 5, "ale" = 5)
			result_amount = 10
		...
		wine11
			...
			id = "wine"
			result = "portsons"
			required_reagents = list("winemeh" = 1, "sugar" = 1)
			result_amount = 2
		...
		wine12
			...
			id = "elwine"
			result = "elwine"
			required_reagents = list("winemeh" = 1, "sodiumchloride" = 1)
			result_amount = 2

		wine13
			name = "Slaughterson Wine"
			id = "slaughterwine"
			result = "slaughterwine"
			required_reagents = list("winemeh" = 1, "beer" = 1)
			result_amount = 2
		...
		wine21
			...
			id = "malantha"
			result = "malanthawine"
			required_reagents = list("winepgood" = 1, "sugar" = 1)
			result_amount = 2
		...
		wine22
			...
			id = "scooterwine"
			result = "elwine"
			required_reagents = list("winepgood" = 1, "sodiumchloride" = 1)
			result_amount = 2
		...
		wine23
			...
			id = "luiwine"
			result = "luiwine"
			required_reagents = list("winepgood" = 1, "beer" = 1)
			result_amount = 2
		...
		wine31
			...
			id = "foospunch"
			result = "foospunch"
			required_reagents = list("winehshitholyshit" = 1, "beer" = 1)
			result_amount = 2
		...
		wine32
			...
			id = "foospunch"
			result = "foospunch"
			required_reagents = list("winehshitholyshit" = 1, "sugar" = 1)
			result_amount = 2
		...
		wine33
			...
			id = "foospunch"
			result = "foospunch"
			required_reagents = list("winehshitholyshit" = 1, "sodiumchloride" = 1)
			result_amount = 2
		...
		battermix
			...
			id = "batter"
			result = "batter"
			required_reagents = list("sugar" = 100, "milk" = 100, "flour" = 100, "xenon" = 100, "indium" = 100)
			result_amount = 50