/mob/living/carbon/human/examine()
	...
	var/temp = get_brute_loss() //no need to calculate each of these twice
	...
	if(physeffect == ASSLESS)
		msg += "[t_He] [t_is] missing [t_his] ass.</span>\n"
	if(physeffect == FACESCAR)
		msg += "[t_He] has a deep scar on [t_his] face.</span>\n"
