...
/mob/living/silicon/pai/proc/medicalAnalysis()
	...
	if(src.subscreen == 1)
		...
		Scan Breakdown: <br>
		Respiratory: [M.oxy_damage > 50 ? "<font color=#FF5555>" : "<font color=#55FF55>"][M.oxy_damage]</font><br>
		Toxicology: [M.tox_damage > 50 ? "<font color=#FF5555>" : "<font color=#55FF55>"][M.tox_damage]</font><br>
		Burns: [M.get_fire_loss() > 50 ? "<font color=#FF5555>" : "<font color=#55FF55>"][M.get_fire_loss()]</font><br>
		Structural Integrity: [M.get_brute_loss() > 50 ? "<font color=#FF5555>" : "<font color=#55FF55>"][M.get_brute_loss()]</font><br>
