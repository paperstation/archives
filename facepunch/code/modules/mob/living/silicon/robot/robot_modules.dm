//Every cyborg has a module, the module contains every item the cyborg has access too, sans radio, it also determines what icon the borg should be using.
/obj/item/weapon/robot_module
	...
	//var/obj/item/emag = null//This should be removed and replaced with a locked thing
...
/obj/item/weapon/robot_module/security
	...
	New()
		...
		src.modules += new /obj/item/weapon/gun/energy/laser/cyborg(src)//Higher level R&D only module, if this gets abused then we can remove it
		return
