...
/mob/living/silicon/robot/show_laws(var/everyone = 0)
	...
	laws.show_laws(who)
	if (connected_ai)
		who << "<b>[connected_ai.name] is your master, other AIs can be ignored.</b>"
	//if (mind && (mind.special_role == "traitor" && mind.original == src) && connected_ai)
	//	who << "<b>Remember, [connected_ai.name] is technically your master, but your objective comes first.</b>"
	else if (emagged)
		who << "<b>You are not required to listen to the AI.</b>"
	else
		who << "<b>You are not bound to any AI, you are not required to listen to them.</b>"
