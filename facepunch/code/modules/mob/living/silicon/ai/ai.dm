...
/mob/living/silicon/ai
	...
	anchored = 1 // -- TLE
	density = 1
	status_flags = 0//No push, no para, no weaken
	var/list/network = list("SS13")
	var/obj/machinery/camera/current = null
	var/list/connected_robots = list()
	var/powerlossdetected = 0
	//var/list/laws = list()
...
/mob/living/silicon/ai/New(loc, var/datum/ai_laws/L, var/obj/item/device/mmi/B, var/safety = 0)
	...
	spawn()	//hacky spaghetti code, but it's the only way without a total rewrite (which I will try to get around to doing) ~carnie x
		fully_replace_character_name(null,get_preferred_ai_name(ckey))
...
/mob/living/silicon/ai/verb/pick_icon()
	...
	var/icontype = input("Please, select a display!", "AI", null) in list("Clown", "Monochrome", "Blue", "Inverted", "Firewall", "Green", "Red", "Static", "Janus", "Pizza", "Inspector")
	if(icontype == "Clown")
	...
	else if(icontype == "Janus")
		icon_state = "ai-janus"
	else if(icontype == "Pizza")
		icon_state = "ai-pizza"
...
/mob/living/silicon/ai/proc/ai_statuschange()
	...
	if(usr.stat == 2)
		...
		return
	var/list/ai_emotions = list("Very Happy", "Happy", "Neutral", "Unsure", "Confused", "Sad", "BSOD", "Blank", "Problems?", "Awesome", "Facepalm", "Friend Computer", "Oh God Why", "Remove Kebab")
