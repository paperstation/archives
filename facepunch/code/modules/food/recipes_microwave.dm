...
/datum/recipe/ianburger
	reagents = list("flour" = 5)
	items = list(
		/obj/item/weapon/reagent_containers/food/snacks/meat/corgi
	)
	result = /obj/item/weapon/reagent_containers/food/snacks/ianburger
...
/datum/recipe/christmascookie
	reagents = list("batter" = 50)
	items = list(
		/obj/item/weapon/reagent_containers/food/snacks/egg,
		/obj/item/weapon/reagent_containers/food/snacks/egg,
		/obj/item/weapon/reagent_containers/food/snacks/egg,
	...
	result = /obj/item/weapon/reagent_containers/food/snacks/cookie/christmas