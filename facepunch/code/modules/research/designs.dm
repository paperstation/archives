...
datum/design						//Datum for object designs, used in construction
	...
	var/locked = 0						//If true it will spawn inside a lockbox with currently sec access, if a gun it will simply add a weapon lock to the gun
...
datum/design/mafia_module
	name = "Core Module Design (M.A.F.I.A.)"
	desc = "Allows for the construction of a M.A.F.I.A. AI Core Module."
	id = "paladin_module"
	req_tech = list("programming" = 4, "materials" = 6)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20, "$diamond" = 100)
	build_path = "/obj/item/weapon/aiModule/mafia"

datum/design/chain_module
	name = "Core Module Design (C.H.A.I.N.)"
	desc = "Allows for the construction of a C.H.A.I.N. AI Module."
	id = "tyrant_module"
	req_tech = list("programming" = 4, "syndicate" = 2, "materials" = 6)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20, "$diamond" = 100)
	build_path = "/obj/item/weapon/aiModule/chain"

datum/design/prod_module
	name = "Core Module Design (P.R.O.D.U.C.T.I.O.N.)"
	desc = "Allows for the construction of a P.R.O.D.U.C.T.I.O.N. AI Module."
	id = "tyrant_module"
	req_tech = list("programming" = 4, "syndicate" = 2, "materials" = 6)
	build_type = IMPRINTER
	materials = list("$glass" = 2000, "sacid" = 20, "$diamond" = 100)
	build_path = "/obj/item/weapon/aiModule/production"
...
datum/design/adamcontainer
	name = "Adamantite Container"
	desc = "Holds adamantite, all kinds."
	id = "adamantite"
	req_tech = list("materials" = 3, "powerstorage" = 2, "engineering" = 2)
	build_type = PROTOLATHE
	materials = list("$metal" = 500, "$glass" = 100, "$silver" = 50)
	build_path = "/obj/item/weapon/storage/bag/adam"

datum/design/adamcore
	name = "fused admantite-diamond core"
	desc = "Do not throw, ever."
	id = "adamantite"
	req_tech = list("materials" = 3, "powerstorage" = 3, "engineering" = 2)
	build_type = PROTOLATHE
	materials = list("$metal" = 10, "$glass" = 10, "$diamond" = 10)
	build_path = "/obj/item/adamantitecore/diamond"
...
/datum/design/borg_security_module
	name = "Borg Security Upgrade"
	desc = "Allows for the construction of security upgrades for cyborgs"
	id = "borg_security_module"
	build_type = MECHFAB
...
datum/design/starship/part2
	name = "Bluespace Crane"
	desc = "A part to make a starship."
	id = "starshippart2"
	req_tech = list("programming" = 3, "magnets" = 4, "materials" = 4, "bluespace" = 2)
	build_type = PROTOLATHE
	materials = list("$metal" = 50, "$glass" = 50)
	build_path = "/obj/item/starship/part2"

datum/design/starship/part3
	...
	build_type = PROTOLATHE
	materials = list("$metal" = 50, "$glass" = 50)
	build_path = "/obj/item/starship/part3"
...
datum/design/custgun
	name = "Custom Gun base"
	desc = "The starting base of a custom gun."
	id = "cgb"
	req_tech = list("combat" = 3, "materials" = 4, "engineering" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 1000, "sacid" = 75, "$diamond" = 50)
	build_path = "/obj/item/weapon/gun/custom"


datum/design/modulerand
	name = "Random Gun Module"
	desc = "The part of a custom gun."
	id = "randommod"
	req_tech = list("combat" = 3, "materials" = 4, "engineering" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 100, "sacid" = 10, "$diamond" = 10)
	build_path = "/obj/item/gunparts/modules/rand"

datum/design/cricuitrand
	name = "Random Gun Circuit"
	desc = "The part of a custom gun."
	id = "randommod"
	req_tech = list("combat" = 3, "materials" = 4, "engineering" = 4)
	build_type = IMPRINTER
	materials = list("$glass" = 100, "sacid" = 10, "$diamond" = 10)
	build_path = "/obj/item/gunparts/circuits/rand"
