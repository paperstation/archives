...
/obj/machinery/light/process_power(seconds)
	if(on)
		use_power(luminosity * LIGHTING_POWER_FACTOR * seconds, LIGHT)
...
/obj/structure/interrolight/proc/light()
	if(!on)
		icon_state = "bulb0"
	else
