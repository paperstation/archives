...
/obj/machinery/power/port_gen/pacman/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(!active)
		...
		if(istype(O, /obj/item/weapon/crowbar) && !open)
...
/obj/machinery/power/port_gen/pacman/blinky
	name = "B.L.I.N.K.Y.-type Portable Generator"
	icon_state = "portgen2"
	sheet_path = /obj/item/weapon/ore/adamantite
	power_gen = 300
	time_per_sheet = 300
	board_path = "/obj/item/weapon/circuitboard/pacman/blinky"
	overheat()
