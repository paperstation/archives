...
//These sounds are (mostly) taken from Hidden: Source
						var/list/creepyasssounds = list('sound/effects/ghost.ogg', 'sound/effects/ghost2.ogg', 'sound/effects/Heart Beat.ogg', 'sound/effects/screech.ogg',\
							...
							'sound/hallucinations/turn_around1.ogg', 'sound/hallucinations/turn_around2.ogg', 'sound/hallucinations/veryfar_noise.ogg', 'sound/hallucinations/wail.ogg', 'sound/mobs/samurai/SkeletonReanimate.ogg', 'sound/voice/ghoul.ogg')
				...
				if(!halbody)
					...
					if(possible_points.len)
						...
						switch(rand(1,5))
							...
							if(5)
								halbody = image('icons/mob/animal.dmi',target,"harmbaton",TURF_LAYER)
