...
/obj/structure/closet/secure_closet/miner
	...
	#ifdef NEWMAP
	req_access = list(access_mining_bay_area)
	#else
	...
	New()
		...
		new /obj/item/clothing/suit/space/rig/mining(src)
		new /obj/item/clothing/head/helmet/space/rig/mining(src)
...
proc/move_mining_shuttle()
	...
	spawn(mining_shuttle_tickstomove*10)
		...
		for(var/mob/living/M in toArea)
			if(M.client)
				spawn(0)
					if(M.buckled)
...
/obj/item/weapon/shovel/adamantite
	name = "enhanced shovel"
	desc = "A large tool for digging and moving dirt, quickily."
	icon = 'icons/obj/items.dmi'
