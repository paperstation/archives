...
/turf/simulated/mineral/random
	...
	var/mineralAmtList = list("Uranium" = 5, "Iron" = 5, "Diamond" = 5, "Gold" = 5, "Silver" = 5, "Plasma" = 5, "Adamantite" = 7)
	var/mineralSpawnChanceList = list("Uranium" = 5, "Iron" = 50, "Diamond" = 1, "Gold" = 5, "Silver" = 5, "Plasma" = 25, "Adamantite" =7)//Currently, Adamantine won't spawn as it has no uses. -Durandan
	...
	if (prob(mineralChance))
		...
		if (mName)
			...
			switch(mName)
				...
				if("Adamantite")
					M = new/turf/simulated/mineral/adamantite(src)
			if(M)
				src = M
				M.levelupdate()
	return
...
/turf/simulated/mineral/random/high_chance
	mineralChance = 25
	mineralSpawnChanceList = list("Uranium" = 10, "Iron" = 30, "Diamond" = 2, "Gold" = 10, "Silver" = 10, "Plasma" = 25, "Adamantite" = 15)
...
/turf/simulated/mineral/adamantite
	name = "Adamantite deposit"
	icon_state = "rock_Adamantite"
	mineralName = "Adamantite"
	mineralAmt = 5
	spreadChance = 5
	spread = 1
...
/turf/simulated/mineral/proc/gets_drilled()
	if ((src.mineralName != "") && (src.mineralAmt > 0) && (src.mineralAmt < 11))
		...
		for (i=0;i<mineralAmt;i++)
			...
			if (src.mineralName == "Adamantite")
				new /obj/item/weapon/ore/adamantite(src)
...
/turf/simulated/floor/plating/airless/asteroid/attackby(obj/item/weapon/W as obj, mob/user as mob)
	...
	if ((istype(W, /obj/item/weapon/shovel/adamantite)))
		var/turf/T = user.loc
		if (!( istype(T, /turf) ))
			return
