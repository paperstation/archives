...
/datum/admins/proc/quick_create_object(var/mob/user)
	...
	pathtext = input("Select the path of the object you wish to create.", "Path", "/obj") in list("/obj","/obj/structure","/obj/item","/obj/item/weapon","/obj/effect","/obj/machinery", "/obj/item/clothing", "/obj/item/stack", "/obj/item/machinery/canister")
