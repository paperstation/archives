...
*/
		...
		if("centcom commander")
			...
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/space/swat/officer(M), slot_wear_suit)
		...
		if("centcom engineer")
			M.equip_to_slot_or_del(new /obj/item/clothing/under/yellowgreen(M), slot_w_uniform)
			M.equip_to_slot_or_del(new /obj/item/clothing/suit/hazardvest(M), slot_wear_suit)
			M.equip_to_slot_or_del(new /obj/item/clothing/shoes/green(M), slot_shoes)
			M.equip_to_slot_or_del(new /obj/item/clothing/gloves/yellow(M), slot_gloves)
			M.equip_to_slot_or_del(new /obj/item/device/radio/headset/heads/captain(M), slot_ears)
			M.equip_to_slot_or_del(new /obj/item/clothing/glasses/thermal/syndi(M), slot_glasses)
			M.equip_to_slot_or_del(new /obj/item/clothing/mask/cigarette/cigar/cohiba(M), slot_wear_mask)
			M.equip_to_slot_or_del(new /obj/item/clothing/head/hardhat/orange(M), slot_head)
