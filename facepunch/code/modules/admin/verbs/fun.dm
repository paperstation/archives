...
/mob/living/carbon/human/proc/equip_samurai(mob/living/carbon/human/samurai_mob)
	...
	for(var/obj/item/W in samurai_mob)
		samurai_mob.drop_from_inventory(W)
	...
	samurai_mob.equip_to_slot_or_del(new /obj/item/clothing/shoes/brown(samurai_mob), slot_shoes)
	...
	new /obj/item/weapon/implant/samurai (samurai_mob)
	samurai_mob.regenerate_icons()
	for(var/obj/item/clothing/W in samurai_mob)
		W.can_remove = 0
	samurai_mob.client.screen += new/obj/screen/samurai/skill1
	samurai_mob.client.screen += new/obj/screen/samurai/skill2
	samurai_mob << "You are a Samurai. <b>YOU ARE AN ANTAG. NO PANSY FRIENDLY ANTAG SHIT</b>. Your lower of the two skills on the left side of your screen will place a Crystal at no cooldown. Press it again when a dead body is nearby the crystal to have the soul absorbed into it. The upper skill requires at least one soul inside of the crystal to work, using said skill teleports you back to the crystal but destroys a soul inside of the crystal and you will need to find more."
	return 1
