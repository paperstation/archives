...
/client/proc/cmd_admin_traitor_narrate() // Allows administrators to fluff events a little easier -- TLE
	set category = "Special Verbs"
	set name = "Antag Narrate"
	...
	for(var/datum/mind/traitors in ticker.mode.traitors)
		...
		if(M)
			M << msg
	log_admin("AntagNarrate: [key_name(usr)] : [msg]")
	message_admins("\blue \bold AntagNarrate: [key_name_admin(usr)] : [msg]<BR>", 1)
...
/proc/create_xeno(ckey)
	...
	switch(alien_caste)
		...
		if("Praetorian")new_xeno = new /mob/living/carbon/alien/humanoid/praetorian(spawn_here)
...
/proc/create_ERT(ckey)
	...
	var/alien_caste = input(usr, "Please choose which caste to spawn.","Pick a profession (I suggest a 1, 1, 3 ratio depending on the situation.)",null) as null|anything in list("Medic","Engineer","Normal")
	...
	switch(alien_caste)
		if("Engineer")
			new_xeno = new /mob/living/carbon/human(spawn_here)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/under/yellowgreen(new_xeno), slot_w_uniform)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/suit/hazardvest(new_xeno), slot_wear_suit)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/shoes/green(new_xeno), slot_shoes)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/gloves/yellow(new_xeno), slot_gloves)
			new_xeno.equip_to_slot_or_del(new /obj/item/device/radio/headset/heads/captain(new_xeno), slot_ears)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/glasses/thermal/syndi(new_xeno), slot_glasses)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/mask/cigarette/cigar/cohiba(new_xeno), slot_wear_mask)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/head/hardhat/orange(new_xeno), slot_head)
			new_xeno.equip_to_slot_or_del(new /obj/item/weapon/storage/belt/utility/full(new_xeno), slot_belt)
			new_xeno.equip_to_slot_or_del(new /obj/item/weapon/lighter/zippo(new_xeno), slot_r_store)
			new_xeno.gender = pick(MALE, FEMALE)
			var/commando_name = pick(last_names)
			new_xeno.real_name = "ERT Engineer [commando_name]"
			new_xeno.age = rand(35,45)
			new_xeno.dna.ready_dna(new_xeno)//Creates DNA.

			var/obj/item/weapon/card/id/W = new(new_xeno)
			W.name = "[new_xeno.real_name]'s ID Card"
			W.icon_state = "centcom"
			W.access = get_all_accesses()
			W.access += get_all_centcom_access()
			W.assignment = "ERT Engineer"
			W.registered_name = new_xeno.real_name
			new_xeno.equip_to_slot_or_del(W, slot_wear_id)

		if("Medic")
			new_xeno = new /mob/living/carbon/human(spawn_here)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/under/rank/medical/blue(new_xeno), slot_w_uniform)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/suit/labcoat(new_xeno), slot_wear_suit)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/shoes/black(new_xeno), slot_shoes)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/gloves/white(new_xeno), slot_gloves)
			new_xeno.equip_to_slot_or_del(new /obj/item/device/radio/headset/heads/captain(new_xeno), slot_ears)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/glasses/thermal/librarian(new_xeno), slot_glasses)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/mask/surgical(new_xeno), slot_wear_mask)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/head/nursehat(new_xeno), slot_head)
			new_xeno.equip_to_slot_or_del(new /obj/item/weapon/storage/belt/medical(new_xeno), slot_belt)
			new_xeno.gender = pick(MALE, FEMALE)
			var/commando_name = pick(last_names)
			new_xeno.real_name = "ERT Doctor [commando_name]"
			new_xeno.age = rand(55,65)
			new_xeno.dna.ready_dna(new_xeno)//Creates DNA.
		...
		if("Normal")
			new_xeno = new /mob/living/carbon/human(spawn_here)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/under/lawyer/black(new_xeno), slot_w_uniform)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/suit/reporterjacket(new_xeno), slot_wear_suit)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/shoes/laceup(new_xeno), slot_shoes)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/gloves/white(new_xeno), slot_gloves)
			new_xeno.equip_to_slot_or_del(new /obj/item/device/radio/headset/heads/captain(new_xeno), slot_ears)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/glasses/thermal/librarian(new_xeno), slot_glasses)
			new_xeno.equip_to_slot_or_del(new /obj/item/clothing/head/beret(new_xeno), slot_head)
			new_xeno.gender = pick(MALE, FEMALE)
			var/commando_name = pick(last_names)
			new_xeno.real_name = "ERT Member [commando_name]"
			new_xeno.age = rand(55,65)
			new_xeno.dna.ready_dna(new_xeno)//Creates DNA.
	...
	new_xeno.ckey = ckey
	message_admins("\blue [key_name_admin(usr)] has spawned [ckey] as an ERT [alien_caste].", 1)
//	new_xeno.
	return 1
...
/client/proc/cmd_admin_create_synd_report()
	...
	if(confirm == "Yes")
		...
		command_alert("An enemy intercept has been downloaded and printed out at all communications consoles.", "Incoming Intercepted Message");
		for (var/obj/machinery/computer/communications/C in machines)
			if(! (C.stat & (BROKEN|NOPOWER) ) )
				var/obj/item/weapon/paper/P = new /obj/item/weapon/paper( C.loc )
...
/client/proc/cmd_admin_explosion(atom/O as obj|mob|turf in world)
	...
	if ((devastation != -1) || (heavy != -1) || (light != -1) || (flash != -1))
		...
		explosion(O, devastation, heavy, light, flash,1,1)
...
/client/proc/cmd_admin_gib_self()
	...
	if(confirm == "Yes")
		...
		//message_admins("\blue [key_name_admin(usr)] used gibself.", 1)//This does not need to be here.
...
/client/proc/cmd_manual_ban()
	...
	switch(alert("How would you like to ban someone today?", "Manual Ban", "Key List", "Enter Manually", "Cancel"))
		if("Key List")
			...
			for(M in world)
				keys += M.client
			var/selection = input("Please, select a player!", "Key Select", null, null) as null|anything in keys
			if(!selection)
				return
			M = selection:mob
		if("Enter Manually")
			var/selection = input(usr,"Input name of person being banned","player key") as text
			if(!selection)
				return
			M = selection
	...
	switch(alert("Temporary Ban?",,"Yes","No"))
		if("Yes")
			...
			if(!reason)
				return
			if(M)
				AddBan(M, null, reason, usr.client.key, 1, mins)
