...
/mob/living/carbon/human/proc/equip_syndicate_commando(syndicate_leader_selected = 0)
	...
	equip_to_slot_or_del(new /obj/item/clothing/suit/space/syndicate/blue(src), slot_wear_suit)
	equip_to_slot_or_del(new /obj/item/clothing/gloves/combat(src), slot_gloves)
	equip_to_slot_or_del(new /obj/item/clothing/head/helmet/space/syndicate/blue(src), slot_head)
