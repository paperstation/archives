...
var/eventTimeLower = 15000	//25 minutes
var/eventTimeUpper = 30000	//50 minutes
...
/proc/checkEvent()
	if(!scheduledEvent)
		scheduledEvent = world.time + rand(eventTimeLower, eventTimeUpper)

	else if(world.time > scheduledEvent)
		spawnEvent()
