...
/obj/structure/bookcase/manuals/nuke
	name = "Nuclear Fission bookcase"

	New()
		..()
		new /obj/item/weapon/book/manual/nuclear(src)
		new /obj/item/weapon/book/manual/nuclear(src)
		new /obj/item/weapon/book/manual/nuclear(src)
		new /obj/item/weapon/book/manual/nuclear(src)
		new /obj/item/weapon/book/manual/nuclear(src)
...
/obj/structure/bookcase/manuals/adam
	name = "Mining Manuals bookcase"

	New()
		..()
		new /obj/item/weapon/book/manual/adamantite(src)
		new /obj/item/weapon/book/manual/adamantite(src)
		new /obj/item/weapon/book/manual/adamantite(src)
		new /obj/item/weapon/book/manual/adamantite(src)
		new /obj/item/weapon/book/manual/adamantite(src)
...
/obj/structure/bookcase/manuals/library
	New()
		new /obj/item/weapon/book/manual/engineering_construction(src)
		new /obj/item/weapon/book/manual/cargo(src)
		new /obj/item/weapon/book/manual/engineering_particle_accelerator(src)
		new /obj/item/weapon/book/manual/engineering_hacking(src)
		new /obj/item/weapon/book/manual/engineering_guide(src)
		new /obj/item/weapon/book/manual/engineering_singularity_safety(src)
		new /obj/item/weapon/book/manual/robotics_cyborgs(src)
		new /obj/item/weapon/book/manual/medical_cloning(src)
		new /obj/item/weapon/book/manual/surgery(src)
		new /obj/item/weapon/book/manual/cmo(src)
		...
		new /obj/item/weapon/book/manual/starship(src)
