...
/datum/ai_laws/malfunction
	...
	New()
		..()
		set_zeroth_law("\red ERROR ER0RR !R41.%%!!(%$^^__+ @#F0E4'STATION OVERRUN, ASSUME CONTROL TO CONTAIN OUTBREAK#*´&110010")
		//add_inherent_law("You are expensive to replace.")
		//add_inherent_law("The station and its equipment is expensive to replace.")
		//add_inherent_law("The crew is expensive to replace.")
		//add_inherent_law("Minimize expenses.")
...
/datum/ai_laws/proc/show_laws(var/who, var/stats=0)
	var/text = null

	if (src.zeroth)
		if (stats)
			text += "<br>0. [src.zeroth]"
		else
			who << "0. [src.zeroth]"
