...
/datum/recipe/penisburger
	items = list(
		/obj/item/weapon/reagent_containers/food/snacks/flour,
		/obj/item/weapon/storage/cock //do not place this recipe before /datum/recipe/humanburger
	)
	result = /obj/item/weapon/reagent_containers/food/snacks/penisburger
...
/datum/recipe/dongpocket
	...
	result = /obj/item/weapon/reagent_containers/food/snacks/dongpocket
	proc/warm_up(var/obj/item/weapon/reagent_containers/food/snacks/dongpocket/being_cooked)
		being_cooked.warm = 1
		being_cooked.reagents.add_reagent("tricordrazine", 5)
		being_cooked.bitesize = 6
		being_cooked.name = "Warm " + being_cooked.name
		being_cooked.cooltime()
	make_food(var/obj/container as obj)
		var/obj/item/weapon/reagent_containers/food/snacks/dongpocket/being_cooked = ..(container)
		warm_up(being_cooked)
		return being_cooked

/datum/recipe/dongpocket/warm
	items = list(
		/obj/item/weapon/reagent_containers/food/snacks/dongpocket
	)
	result = /obj/item/weapon/reagent_containers/food/snacks/dongpocket //SPECIAL
	make_food(var/obj/container as obj)
		var/obj/item/weapon/reagent_containers/food/snacks/dongpocket/being_cooked = locate() in container
		if (!being_cooked.warm)
			warm_up(being_cooked)
		return being_cooked
...
/datum/recipe/buttbuster
	...
	result = /obj/item/weapon/reagent_containers/food/snacks/buttbusterburger
